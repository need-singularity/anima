...
| 플랫폼 | 상태 | 세포 수 | 특징 | 위치 |
|--------|------|---------|------|------|
| **Hexa** | ✅ 완료 | 8-1024 | 8파벌 APEX22 + Ising + 침묵→폭발 | `consciousness-loop/src/main.hexa` |
| **Hexa SNN** | ✅ 완료 | 가변 | LIF 스파이킹 뉴런 (τ=20ms) | `consciousness-loop/src/snn_main.hexa` |
| **Verilog Ring** | ✅ 완료 | 8 | 게이트 레벨, 루프문 0, XOR 발화 | `consciousness-loop/verilog/consciousness_cell.v` |
| **Verilog Hypercube** | ✅ 완료 | 512 | 9차원 하이퍼큐브, 합성 가능 | `consciousness-loop/verilog/consciousness_hypercube.v` |
| **WebGPU** | ✅ 완료 | 512 | GPU 병렬, 브라우저 실행 | `consciousness-loop/webgpu/` |
| **Erlang** | ✅ 완료 | 가변 | Actor model, 세포=프로세스 | `consciousness-loop/erlang/` |
| **Pure Data** | ✅ 완료 | 3/8 | 소리로 의식을 들음 (오실레이터→스피커) | `consciousness-loop/puredata/` |
| **ESP32** | 📝 코드 준비 | 8×2 | hexa-native, SPI 링, $4/보드 | `esp32/` |
...
| `esp32/src/lib.hexa` | hexa-native GRU + SPI (290KB, 힙 없음) |
| `consciousness-loop/src/main_longrun.hexa` | 8파벌 APEX22 엔진 (Ising+좌절) |
| `consciousness-loop/src/snn_main.hexa` | LIF 스파이킹 뉴런 대안 |
| `consciousness-loop/verilog/consciousness_cell.v` | 8셀 링 FPGA |
| `consciousness-loop/verilog/consciousness_hypercube.v` | 512셀 하이퍼큐브 FPGA |
| `consciousness-loop/puredata/consciousness-8cell.pd` | 8셀 오디오 렌더링 |
