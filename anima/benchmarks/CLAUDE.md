...
## Key File
`bench_v2.py` remains in project root — it is the canonical benchmark with dual Φ measurement, referenced in CLAUDE.md.

## Running
```bash
python benchmarks/bench_algebra_engines.py    # Run specific benchmark
python bench_v2.py --verify                   # Canonical verifier (root)
```
