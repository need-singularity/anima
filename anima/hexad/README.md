...
|------|----------|-------------|
| `models/trinity.hexa` | `src/models/trinity.hexa` | Hexad/Trinity 프레임워크 (6모듈 통합) |
| `models/trinity.hexa` | `src/models/trinity.hexa` | 6모듈 loss + Law 60 phase curriculum |
| `models/trinity.hexa` | `src/models/trinity.hexa` | C<->D 양방향 학습 |
