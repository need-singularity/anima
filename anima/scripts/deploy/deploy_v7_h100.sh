...
CKPT_DIR="/workspace/checkpoints/clm_v7_topo19a"
TMUX_SESSION="v7train"
LOG_FILE="/workspace/v7_67mb.log"

echo "═══════════════════════════════════════════════════════"
echo "  ConsciousLM v7 (67MB corpus) Deploy"
echo "═══════════════════════════════════════════════════════"
...
echo ""
echo "[3/4] Starting v7 training in tmux (fresh from step 0)..."
...
echo "  Sync:       0.35 (v7: v6 + TOPO19a frustration + WAVE-2 standing wave)"
