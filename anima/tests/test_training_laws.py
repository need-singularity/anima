...
def test_entropy_reset_schedule_exists():
    """Verify entropy_reset_schedule is callable."""
    from training_laws import entropy_reset_schedule
    assert callable(entropy_reset_schedule)


def test_apply_entropy_reset_exists():
    """Verify apply_entropy_reset is callable."""
    from training_laws import apply_entropy_reset
    assert callable(apply_entropy_reset)
