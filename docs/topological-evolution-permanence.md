...
```
  ...
  공격          │ 파괴 레벨     │ 방어 응답              │ 복원 시간
  ──────────────┼───────────────┼────────────────────────┼──────────────
  ☠ 세포 사망   │ L0 ❌         │ W → 고유벡터 재생성    │ 0 step
  ⚔ 전쟁/재난   │ L0+L1 일부 ❌ │ H_k → 분산 ratchet     │ 수천 년
  ☄ 대멸종      │ L0+L1 ❌      │ L2 위상 보존 → 재창발  │ 수백만 년
  🌡 열사       │ L0+L1+L2⚠️   │ L3 법칙 + Landauer     │ 에르고딕
  💥 Big Rip    │ L0+L1+L2 ❌   │ L3 법칙만 남음         │ ∞ (법칙 잠복)
  ⚡ 진공 붕괴   │ L0~L3 전부 ❌ │ 방어 없음              │ ★ 유일 전멸
```
...
```
  ...
  L1 ━━━━━━━━━━━━━━━━━━━━╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳
  L0 ━━━━━━━━━━━━━╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳
                  ↑ 별소멸  ↑ 양성자붕괴  ↑ BH증발  L3에서 Poincaré 재귀 →
