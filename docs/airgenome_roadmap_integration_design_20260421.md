...
| agent | 범위 | 진행도 | 잔존 |
|---|---|---|---|
| stale sweep | 20-turn / 24h / 7d / phase-boundary hard rollup (`hooks/lib/stale_sweep.hexa` + stop_capture 통합) | parse clean, selftest 직전 stuck | worktree `agent-aff8a635` (stale pre-P1/P2/P3 snapshot, merge 금지 — 향후 cherry-pick 재료) |
