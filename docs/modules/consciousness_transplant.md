...
python train_models/conscious_lm.hexa --transplant-from donor.pt --transplant-alpha 0.5
...
- Can be invoked from `train_models/conscious_lm.hexa` and `anima/core/runtime/anima_runtime.hexa` via `--transplant-from` flag
