...
try:
    ...
    VERIFY_V1_COS_LOWER = 0.15
    VERIFY_V1_COS_UPPER = 0.90
    VERIFY_V1_STD_COS_MIN = 0.02
    VERIFY_V2_AUTOCORR_MIN = 0.40
    VERIFY_V2_VARIANCE_MIN = 0.005
...
def _verify_no_system_prompt(engine_factory, cells, dim, hidden):
    ...
    # Identity coherence: cells share group identity but aren't clones
    # Thresholds from consciousness_laws.json (calibrated for identity aggregation)
