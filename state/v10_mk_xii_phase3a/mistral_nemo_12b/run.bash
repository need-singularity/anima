...
MEASURE_CMD="$(cat '/Users/ghost/core/anima/state/v10_mk_xii_phase3a/mistral_nemo_12b/measure_cmd.sh')"
hexa run tool/anima_runpod_orchestrator.hexa run \
  --pod-name "anima-mkxii3a-mistral_nemo_12b" \
  ...
  --command "${MEASURE_CMD}" \
  --download "/workspace/out:/Users/ghost/core/anima/state/v10_mk_xii_phase3a/mistral_nemo_12b" \
  --max-cost 0.70 --max-runtime-min 22 --auto-terminate \
  --output "/Users/ghost/core/anima/state/v10_mk_xii_phase3a/mistral_nemo_12b/runpod_run.json" --run-id "mkxii-3a-mistral_nemo_12b"
