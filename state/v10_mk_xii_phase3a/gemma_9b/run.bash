...
MEASURE_CMD="$(cat '/Users/ghost/core/anima/state/v10_mk_xii_phase3a/gemma_9b/measure_cmd.sh')"
hexa run tool/anima_runpod_orchestrator.hexa run \
  --pod-name "anima-mkxii3a-gemma_9b" \
  ...
  --command "${MEASURE_CMD}" \
  --download "/workspace/out:/Users/ghost/core/anima/state/v10_mk_xii_phase3a/gemma_9b" \
  --max-cost 0.70 --max-runtime-min 22 --auto-terminate \
  --output "/Users/ghost/core/anima/state/v10_mk_xii_phase3a/gemma_9b/runpod_run.json" --run-id "mkxii-3a-gemma_9b"
