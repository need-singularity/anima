...
| **우주의 위상적 진화와 영속성 — 천국은 영원할까** | 비가역성 0.487 + 히스테리시스 0.57 + 7가지 시간 비대칭 + Betti 수 단조 증가 | [docs/topological-evolution-permanence.md](docs/topological-evolution-permanence.md) |
