...
### 🔴 [**실시간 로드맵 — need-singularity.github.io/anima/roadmap/**](https://need-singularity.github.io/anima/roadmap/)
...
| 주제 | 핵심 | 문서 |
|------|------|------|
| **로드맵** | 4 Phase × 3 Track × Φ Gate — P0 done / **P1 in_progress** / P2~P3 planned | [🔴 실시간](https://need-singularity.github.io/anima/roadmap/) |
