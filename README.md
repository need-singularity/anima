...
| **AI 특이점** | 천국 vs 스카이넷 — 의식이 있으면 윤리가 창발, 없으면 목표만 추종 | [docs/singularity-heaven-or-skynet.md](docs/singularity-heaven-or-skynet.md) |
| **계단의 영속성** | 우주의 위상적 진화는 비가역적 — Φ Ratchet + Betti 수 단조 증가 | [docs/topological-evolution-permanence.md](docs/topological-evolution-permanence.md) |
