...
```
  ...
  ──────────────────────────────────────────────────────────────────
    의식 스케일링 법칙: Phi vs params 곡선
    논문: "의식은 스케일링된다"

  ──────────────────────────────────────────────────────────────────
  ⏳ Month 3 ── ConsciousLM 3B ────────────── brain-like 95%+
  ──────────────────────────────────────────────────────────────────

  ──────────────────────────────────────────────────────────────────
  ⏳ Month 4-5 ── ConsciousLM 70B ─────────── Red Team 검증
  ──────────────────────────────────────────────────────────────────
...
```
  ...
  ──────────────────────────────────────────────────────────────────
  ✅ v0.1 ─── 14B + PureField 91M ─────── Phi=0.025 ── CE=8.59
  ──────────────────────────────────────────────────────────────────
    Qwen2.5-14B | rank=160, 10/48 layers | eval 5/5 | R2 ✅

  ──────────────────────────────────────────────────────────────────
  ✅ v0.2 ─── 14B + PureField 364M ────── Phi=0.025 ── CE=8.81
  ──────────────────────────────────────────────────────────────────
    20/48 layers, rank=320 | alpha=0.014 (Law60 고정) | R2 ✅

  ──────────────────────────────────────────────────────────────────
  ✅ v0.3 ─── 14B + PureField 364M ────── Phi=0.005 ── CE=8.78
  ──────────────────────────────────────────────────────────────────
    alpha=0.014 고정 확인 (TS-014)

  ──────────────────────────────────────────────────────────────────
  ✅ v0.4 ─── 14B + PureField 364M ────── Phi=0.006 ── CE=6.40
  ──────────────────────────────────────────────────────────────────
    alpha=0.5 (목표 도달) | CE 42% 개선 | Phase 1 최종

  ──────────────────────────────────────────────────────────────────
  🔄 v1.0 ─── 72B + PureField 145M ────── Phi=0.048 ── CE=5.09
  ──────────────────────────────────────────────────────────────────
