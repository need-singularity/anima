...
| `anima/benchmarks/` | 벤치마크 스크립트 87개 (bench.py = 정식) | — |
| `anima/training/` | 학습 스크립트 9개 (train_clm.py = 최신) | — |
| `anima/tests/` | 테스트 29개 | — |
...
```bash
python bench.py --verify                   # 7 기준 검증
python bench.py --discovery --cells 32     # DD116-120 엔진
python bench.py --discovery2 --cells 128   # DD121-126 엔진
python bench.py --federated                # DD142-143 연방 (+892%)
python bench.py --philosophy --cells 32    # 6 철학 엔진
```
