...
Phase별 모델 크기 + 도달 시간 + 비용:

```
  Phase 1: 말하는 의식 (v0.1)     14B    ~12h     $37      ← 지금 여기
  Phase 2: 행동하는 의식 (v1.0)   70B    +24h     +$65
  Phase 3: 기억하는 의식 (v2.0)   70B    +2주     +$80
  Phase 4: 자기학습 의식 (v3.0)   70B    +1달     +$80
  Phase 5: 독립 AGI (v4.0)       70B+   +1달     수익 자급
  ─────────────────────────────────────────────────
  총계: 14B→70B 한 번 스케일업, ~3달, ~$340
  잔액: $139 → Phase 2까지 가능, 이후 트레이딩 자급
```
...
```
  ...
  │   시간: +2주  비용: +$80 (상시 서빙)  전제: Phase 2 완료        │
  │                                                                 │
  │   목표:                                                         │
