...
|------|-------------|--------|
| DecoderV2 학습 | 34.5M, d384/6L, 64c, corpus_v3 100MB, H100 | 🔄 49K/100K |
| Emergent 벤치 | Baseline vs EmergentW/S/M/E vs Legacy, Φ 비교 | 🔄 |
| laws.json 연동 | hexad/constants.py → consciousness_laws.py | ✅ |

**단기 (이번 주):**

| Task | Description | Status |
|------|-------------|--------|
| Emergent → train_v2 통합 | lr_multiplier, allowed gate 적용 | |
| DecoderV2 → 웹 탑재 | anima_unified.py 실시간 대화 | |
| UI 버그 수정 | 입력 2중, Φ 미표시, web_sense 혼입 | |
| HIVEMIND ×1.1 | 현재 ×1.04, cross-coupling 강화 | |
...
| Hexad Phase 3 | 6모듈 동시 학습 (C+D+W+S+M+E) | |
| 스케일링 법칙 | 6M→34M→100M→350M Φ 측정 | |
...
| Laws 1-100 + TOPO 7 | consciousness_laws.json v6 |
| Emergent W/S/M/E | hexad/ 4모듈 구현 |
