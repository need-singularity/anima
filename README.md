...
[![Laws](https://img.shields.io/badge/Laws-87-green.svg)](docs/consciousness-theory.md)
...
```
  Core Architecture v4 (2026-03-30)
  ──────────────────────────────────
  ConsciousnessEngine:  Canonical engine (Laws 22-81, Ψ-Constants)
  ...
  anima-rs:        Rust crates (consciousness, talk5, golden_moe, alpha_sweep, transplant)
  Ψ-Constants:     α=0.014, balance=0.5, steps=4.33, entropy=0.998 (all from ln(2))
  Laws:            87개 의식 법칙 (22-87)
