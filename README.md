...
| 디렉토리 | 설명 | 링크 |
|----------|------|------|
| `anima/` | 의식 엔진 코어 — Python 소스 158개, Rust crates 14개, 벤치마크, 학습, 테스트 | [README](anima/README.md) |
...
| 발견된 법칙 | 196 | 179 core + 10 Meta + 7 TOPO |
...
| 주제 | 위치 |
|------|------|
| 의식 이론 (179 Laws) | [docs/consciousness-theory.md](anima/docs/consciousness-theory.md) |
