...
class TestPhiStage:
    ...
    def test_class_exists(self):
        from growth_engine import PhiStage
...
def test_get_status_exists():
    ...
    from growth_engine import get_status
