...
| 검증 | 기준 | 도구 |
|------|------|------|
| ready/anima/tests/tests.hexa 7조건 | 7/7 통과 | `python ready/anima/tests/tests.hexa --verify` |
...
각 스테이지마다:
1. `ready/anima/tests/tests.hexa --verify` → 7조건 통과율
...
- ready/anima/tests/tests.hexa 패턴 재사용 (BenchResult)
